...
builder.Services.AddScoped<IAlliances, AlliancesService>();
builder.Services.AddScoped<IProjects, ProjectsService>();
builder.Services.AddScoped<IProjectImages, ProjectImagesService>();
builder.Services.AddScoped<IProjectProducts, ProjectProductsService>();
