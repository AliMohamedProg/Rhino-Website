        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorsEn = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ColorsAr = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    MaterialEn = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    MaterialAr = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CurrentState = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TbOrderItems_TbItems",
                        column: x => x.ItemId,
                        principalTable: "TbItems",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TbOrderItems_TbOrder",
                        column: x => x.OrderId,
