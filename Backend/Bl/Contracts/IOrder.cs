...
namespace BusinessLayer.Contracts
{
    ...
    {
        Task<TbOrder> CreateOrder(Guid userId, string Country, string paymentMethodName, string City, string Address, decimal Total, string PhoneNumber, string Email, string FirstName, string LastName, string? transactionId = null);
