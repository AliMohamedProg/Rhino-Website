  ...
  return (
    <section className="py-24 px-8 bg-white min-h-screen" id="catalog">
      <div className="max-w-[90rem] mx-auto flex flex-col items-center">
        ...
        <div className="flex overflow-x-auto pb-8 snap-x snap-mandatory md:grid md:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-12 w-full max-w-[90rem] mx-auto no-scrollbar">
